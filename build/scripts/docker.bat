...
set CLASSPATH=%APP_HOME%\lib\json-20171018.jar;%APP_HOME%\lib\docker-1.0-SNAPSHOT.jar;%APP_HOME%\lib\commons-io-2.6.jar

@rem Execute docker
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DOCKER_OPTS%  -classpath "%CLASSPATH%" Service %CMD_LINE_ARGS%
